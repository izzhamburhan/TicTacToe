...
class Player :
    ...
    #kita mahukan setiap pemain punya giliran seterusnya mendapat nama 
...
class HumanPlayer(Player):
    ...
    def get_mode(self,game):
        ...
        while not valid_square:
            ...
            # if that spot is not available not on the board , we also say its invalid
...
class GeniusComputerPlayer(Player):
    ...
    def get_move(self,game):
        if len(game.available_moves()) == 9:
           ...
           #get the square based off the minimax algortihm
    ...
    def minimax(self, state , player ):
        ...
        #first , we want to check th previous move is a winner
